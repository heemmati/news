...
<div class="form-wrapper">
    ...
    <!-- logo -->
    <div id="logo">
        <img class="logo" src="{{ url('admin-theme') }}/assets/media/image/logo.png" alt="image">
        <img class="logo-dark" src="{{ url('admin-theme') }}/assets/media/image/logo-dark.html" alt="image">
    </div>
    <!-- ./ logo -->
