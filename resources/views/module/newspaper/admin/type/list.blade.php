                            ...
                            <div class="card-body">
                                @if(isset($types) && !empty($types))
                                    <table id="example1" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <th>آیدی</th>
                                            <th>عنوان نوع نشریه</th>
                                            <th>وضعیت نوع  نشریه</th>
                                            <th>عملیات</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach( $types as $type)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <x-status-show :status="$type->status"></x-status-show>

                                                </td>

                                                <td>

                                                    <a href="{{ route('newspaper-types.edit' , $type->id) }}">
                                                        <i class="fa fa-pen"></i>
                                                    </a>
                                                    ...
                                                    {{--Deleting Form--}}
                                                    <form action="{{ route('newspaper-types.destroy' , $type->id) }}}"
