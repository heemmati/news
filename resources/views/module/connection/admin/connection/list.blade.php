                                    ...
                                    <table id="example1" class="table table-striped table-bordered">
                                        ...
                                        @foreach( $connections as $connection)
                                            ...
                                            <tr>
                                                ...
                                                @if(isset($connection->parent) && !empty($connection->parent))
                                                    <td>{{ $connection->parent->title }}</td>
                                                @else
                                                    <td>مادر</td>
                                                @endif
                                                ...
                                                <td>
                                                    ...
                                                    {{--Deleting Form--}}
                                                    <form action="{{ route('connections.destroy' , $connection->id) }}}"
