            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('article-origins.update' , $origin->id ) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <x-form.filemanager.image name="image" :value="$origin->images"  namefa="{{ __('site.origin_image') }}" ></x-form.filemanager.image>
                                                    </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">ویرایش منبع خبر</button>
                        </form>
