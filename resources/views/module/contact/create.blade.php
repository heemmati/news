    ...
    <div class="content">
        ...
        <div class="page-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="">ایجاد پرسش و پاسخ جدید</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">ایجاد پرسش و پاسخ جدید</h6>
                        ...
                        <form method="POST" action="{{ route('faqs.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                                  name="description"
                                                  id="" cols="30" rows="10"
                                                  placeholder="توضیحات کوتاه پرسش و پاسخ را وارد کنید"></textarea>
                                        <small class="counter_small"></small>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control body"
                                          ...
                                          name="body"
                                          id="" cols="30" rows="10"
                                          placeholder="متن کامل پرسش و پاسخ را وارد کنید"></textarea>
                                <small class="counter_small"></small>
                            </div>
