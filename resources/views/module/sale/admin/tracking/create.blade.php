            ...
            <form method="POST" action="{{ route('trackings.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        <x-form.select type="پیگیری" name="sale_id" namefa=" مورد فروش " require="1"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <x-form.textarea type="پیگیری" name="isay" namefa="چیزی که من گفتم" require="1"></x-form.textarea>


                    </div>

                    <div class="col-12 col-md-6">
                        <x-form.textarea type="پیگیری" name="hesay" namefa="چیزی که اون گفت" require="1" ></x-form.textarea>
                ...
                <button type="submit" class="btn btn-primary">ایجاد پیگیری  جدید</button>
