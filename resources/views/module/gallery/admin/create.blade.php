    ...
    <div class="content">
        ...
        <div class="page-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="">@lang('site.galleries_management') </a>
                    </li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">@lang('site.galleries_management')</h6>
                        ...
                        <form method="POST" action="{{ route('galleries.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    {{-- Description --}}
                                    <x-form.textarea name="title" namefa="{{ __('site.description') }}"
