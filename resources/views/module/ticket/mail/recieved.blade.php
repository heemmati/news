...
<div class="box" style=" width: 90%;
            ...
            display: flex;
            height: 340px;">
    <div class="box_image" style=" width: 50%;">
        @if(isset($email_sent->getItem('background')->image) && !empty($email_sent->getItem('background')->image))
            <img style="     height: 100%;
            object-fit: contain;" src="{{ \Illuminate\Support\Facades\Storage::url($email_sent->getItem('background')->image) }}"/>
        @endif
    </div>
    <div class="box_desc" style=" width: 50%;">

        @if(isset($main_setting->getItem('logo')->image) && !empty($main_setting->getItem('logo')->image))
{{--            <img style="  width: 90%;--}}
{{--            margin: auto;--}}
{{--            display: block;" src="{{ \Illuminate\Support\Facades\Storage::url($main_setting->getItem('logo')->image) }}"/>--}}
        @endif


            <img style="  width: 90%;
            margin: auto;
            display: block;" src="https://digiafagh.com/storage//logo.png"/>



            <h3>
                تیکتی با شماره پی گیری
                {{ $ticket->code }}
                برای دپارتمان شما به ثبت رسید!
            </h3>
                                            ...
                                            <table border="0" align="left" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                                ...
                                                <tr>
                                                    <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                                            <tr>
                                                                <td width="250" height="60" align="center" bgcolor="#1f3ca6" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="https://www.karnaweb.net" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff" class="button_link">مشاهده سایت<img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/582dc751-b0fc-4769-ad74-35932c7594dd.png" width="32" height="17" style="padding-top:5px" alt="" border="0"/></a></td>
                                                            </tr>
                                                        </table></td>
                                                </tr>
                                                </tbody>
