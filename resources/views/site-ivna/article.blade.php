                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="news-box">
                                ...
                                <div class="news-detail">
                                    ...
                                    <div class="visit">
                                        <span class="visit-text">بازدید:</span>
                                        {{ $view }}
                                    </div>
                                    <div class="share">
                                        <a href="">
                                ...
                                <div class="news-items">
                                    <div class="news-image">
                                        <img src="{{ \Illuminate\Support\Facades\Storage::url($article->image) }}"
                                             alt="{{ $article->title }}" height="120" width="180"/>
                                    </div>
                                    <div class="news-caption">
                                        ...
                                        <div class="news-desc">
                                                        ...
                                                        @foreach($gallery->images as $image)
                                                            <div class="gallery_item">
                                                                <a href="{{ \Illuminate\Support\Facades\Storage::url($image->src) }}">
                                                                    <img src="{{ \Illuminate\Support\Facades\Storage::url($image->src) }}" alt="{{ $image->title }}">
                                                                </a>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            @include('site.inc.videos-box' , ['videos' => $article->videos])

                                            @include('site.inc.body-tags' , ['tags' => $article->tags])
                        ...
                        <!-- Similar News-->
                            ...
                            @include('site.inc.comments' , ['object' => $article , 'comments' => $comments])
